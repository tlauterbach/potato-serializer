...
namespace PotatoSerializer {
	...
	/// </summary>
	internal struct SubString : IEquatable<SubString>, IEquatable<string>, IEnumerable<char> {

		public static readonly SubString Empty = new SubString();
		...
		public SubString(string source, int index) {
